...
variant: markdown
---
<h3 id="whitelisted-websites">Whitelisted Websites</h3>
<p> Once a website has been whitelisted, it can be accessed freely by SLS users as an <strong>External Resource</strong> for teaching and learning. It can also be embedded into a lesson as an iframe so that the lesson can flow more seamlessly.</p>
