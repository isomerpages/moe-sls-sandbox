...
<tr>
        ...
        <tr><td><strong>ClipSee (for HQ Users)</strong></td>
								<td>ClipSee is only available to MOE HQ users to access video aggregation libraries for MOE Library content curation. For more details on school subscription plans for the App, please visit <a href="https://www.boclips.com/boclips-packages" target="_blank">this website</a>.</td></tr>
			   ...
			   <tr><td><strong>EJSS</strong></td>
								<td>EJSS provides interactive science applets with learning analytic capabilities. <a href="https://weelookang.blogspot.com/2023/05/teacher-flow-how-to-add-ejss-simulation.html" target="_blank">Click here</a> to find out more about the EJSS authoring toolkit for the creation of JavaScript simulations.</td></tr>
